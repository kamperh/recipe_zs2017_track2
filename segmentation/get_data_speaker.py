...
def get_data_speaker(speaker, data_dir):
    ...
    print "Total no. of utterances:", len(src_durations_dict)

    print "Speaker:", speaker
    keys = [i for i in src_durations_dict.keys() if i.startswith(speaker)]
    ...
    print "No. of utterances:", len(durations_dict)
